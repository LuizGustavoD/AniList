...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<StandartError> handleEntityNotFoundException(EntityNotFoundException ex) {
    ...
    public ResponseEntity<StandartError> handleAnimeNotFoundException(AnimeNotFoundException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(404);
    ...
    public ResponseEntity<StandartError> handleInvalidTokenException(InvalidTokenException ex){
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(401);
    ...
    public ResponseEntity<StandartError> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(409);
    ...
    public ResponseEntity<StandartError> handleUserNotFoundException(UserNotFoundException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(404);
    ...
    public ResponseEntity<StandartError> handleFriendshipRequestException(FriendshipRequestException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(400);
    ...
    public ResponseEntity<StandartError> handleUnauthorizedActionException(UnauthorizedActionException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(403);
    ...
    public ResponseEntity<StandartError> handleValidationException(ValidationException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(422);
    ...
    public ResponseEntity<StandartError> handleResourceAlreadyExistsException(ResourceAlreadyExistsException ex) {
        StandartError error = new StandartError();
        error.setTimestamp(Instant.now());
        error.setStatus(409);
